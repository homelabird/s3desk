...
- **Done**
  ...
  - Removed antd `Form` usage from UI and patched antd internals so `@rc-component/form` no longer enters the `vendor-ui` chunk.
...
- **Notes**
  ...
  - Current size (local build, 2026-02-14): initial JS ~267 kB / 85 kB (raw / gzip), `vendor-ui` ~604 kB / 194 kB (raw / gzip), `vendor-tanstack-virtual` ~14 kB / 4.8 kB (raw / gzip).
- **Next**
