...
- Command used: `bash ./scripts/deploy_smoke.sh`
- Evidence generated by `DEPLOY_SMOKE_EVIDENCE_FILE`:
...
- Do not include API tokens, provider secrets, or signed proxy URL signatures.
