...
const s3PolicyGuide: BucketDecisionGuide = {
  workspaceTitle: "S3 policy editor workspace",
  workspaceDescription:
    "Choose Controls for routine bucket posture. Use Policy editor when you need raw bucket policy statements, cross-account principals, or condition-heavy JSON.",
  ...
  advancedTitle: "Policy editor: JSON statements",
  advancedDescription:
...
const gcsPolicyGuide: BucketDecisionGuide = {
  workspaceTitle: "GCS IAM policy editor workspace",
  workspaceDescription:
    "Choose Controls for routine exposure and protection changes. Use Policy editor when you need the full IAM document, etag-sensitive updates, or presets.",
  recommendedTitle: "Recommended: Controls first",
  recommendedDescription:
  ...
  advancedTitle: "Policy editor: IAM document",
  advancedDescription:
...
const azurePolicyGuide: BucketDecisionGuide = {
  workspaceTitle: "Azure container access editor workspace",
  workspaceDescription:
    "Choose Controls for routine anonymous access and protection changes. Use Policy editor when you need raw container ACL JSON or preset composition.",
  recommendedTitle: "Recommended: Controls first",
  recommendedDescription:
  ...
  advancedTitle: "Policy editor: ACL JSON",
  advancedDescription:
...
const awsGovernanceGuide: BucketDecisionGuide = {
  ...
  workspaceDescription:
    "Use typed controls for routine S3 bucket posture. Open Policy editor only for raw bucket policy statements.",
  ...
  advancedTitle: "Policy editor: Raw policy",
  advancedDescription:
...
const gcsGovernanceGuide: BucketDecisionGuide = {
  ...
  workspaceDescription:
    "Use typed controls for routine exposure, uniform access, versioning, and retention. Open Policy editor only for full IAM document control.",
  recommendedTitle: "Recommended: Typed controls",
  recommendedDescription:
...
const azureGovernanceGuide: BucketDecisionGuide = {
  ...
  workspaceDescription:
    "Use typed controls for routine anonymous access, stored policies, account-level protection, and immutability. Open Policy editor only for raw ACL JSON.",
  recommendedTitle: "Recommended: Typed controls",
  recommendedDescription:
...
const ociGovernanceGuide: BucketDecisionGuide = {
  ...
  workspaceDescription:
    "Use typed controls for OCI visibility, versioning, retention, and pre-authenticated requests. Provider-native effects stay visible before editing.",
  recommendedTitle: "Recommended: Typed controls",
  recommendedDescription:
  ...
  advancedTitle: "Provider effects to review",
  advancedDescription:
