...
export function buildObjectsPageDataState(args: ObjectsPageDataStateArgs) {
	return {
		...
		cleanupEmptyDirsDefault: args.view.cleanupEmptyDirsDefault,
		...
		moveAfterUploadDefault: args.view.moveAfterUploadDefault,
		...
		setCleanupEmptyDirsDefault: args.view.setCleanupEmptyDirsDefault,
		...
		setMoveAfterUploadDefault: args.view.setMoveAfterUploadDefault,
