...
export function buildObjectsPageViewState({
	...
	return {
		...
		treeResizeMaxWidth: layout.treeResizeMaxWidth,
		treeResizeMinWidth: layout.treeResizeMinWidth,
		treeWidthUsed: layout.treeWidthUsed,
		detailsResizeMaxWidth: layout.detailsResizeMaxWidth,
		detailsResizeMinWidth: layout.detailsResizeMinWidth,
