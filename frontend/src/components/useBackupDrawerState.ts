...
import type { APIClientShape, ServerBackupConfidentialityMode, ServerBackupScope } from '../api/client'
...
export function useBackupDrawerState(args: UseBackupDrawerStateArgs) {
	...
	const {
		...
		backupExportNotice,
		triggerSubtitle,
	} = useMemo(() => buildBackupCapabilitySummary(meta), [meta])
