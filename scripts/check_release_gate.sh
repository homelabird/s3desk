...
require_text "${FRONTEND_E2E_WORKFLOW}" "backend/go.mod" "frontend e2e backend module browser-surface scope"
require_text "${FRONTEND_E2E_WORKFLOW}" "backend/go.sum" "frontend e2e backend dependency browser-surface scope"
require_text "${FRONTEND_E2E_WORKFLOW}" "backend/internal/**" "frontend e2e broad backend browser-surface scope"
